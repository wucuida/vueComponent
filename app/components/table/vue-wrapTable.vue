...
<div :class="['clearfix', className ? className : '']">
	...
	<!--useFixedHeader-->	
	<vue-spin :extra-cls="spinCls" :spinning="loading" :tip="'loading...'">
		<vue-table
			v-ref:vue-table
			:itemdata="itemdata"
			:columns="columns"
...
import vueTable from './vue-outerTable'
import pagination from '../pagination/vue-pagination'
import vueSpin from "../spin/vue-spin"
export default {
	props: {
		dataSource:{
			type: Array,
	...
	computed: {
		...
		spinCls() {
		    ...
		    if(this.hasPagination)
		    	return 'ant-table-with-pagination ant-table-spin-holder '
		    return 'ant-table-without-pagination ant-table-spin-holder '
		}
	},
	created() {
		this.initRender();
