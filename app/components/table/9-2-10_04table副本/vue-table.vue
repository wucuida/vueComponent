...
export default {
	...
	created () {
		...
		//都是围绕columns计算的，要先设置columns
		// this.setCurrentColumns()
		// console.log('table 中：itemdata, col', this.itemdata, this.columns)
		this.initParams()
		// console.log(this.leftFixedColumns, this.rightFixedColumns, 'leftFixed---rightfixed')
		// console.log(this.itemdata, this.columns, 'table----created---itemdata,columns')
	},
	watch: {
		itemdata (val, oldval) {
