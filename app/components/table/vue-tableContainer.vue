		...
		<table :class="tableClassName" :style="innerTableStyle">
	        ...
	        class="ant-table-thead"}>
	        	<tr :style="headTrStyle">
	        		...
	        		<th v-if="hasCheckbox"  class="ant-table-selection-column">
	        			<span>
		        			<vue-checkbox @click="clickCheckbox" :checked="selectPageAll">
		        			</vue-checkbox>
	        			</span>
	        		</th>
...
export default {
	...
	methods: {
		...
		toggleSortOrder(key, order) {
			this.$parent.$parent.$parent.handleClickOrderIcon(key, order)
		},
		...
		clickCheckbox() {
			if(this.selectPageAll){
				this.$parent.$parent.$parent.selectAll(false);
				this.selectPageAll = false
			}else{
				this.$parent.$parent.$parent.selectAll(true);
